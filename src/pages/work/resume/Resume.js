  ...
  return (
    <div className="job-info">
      <div className="job-employer border-accent border-b-2 flex flex-row justify-between">
        <span className="job-employer-name text-xl font-bold py-1">{employer}</span>
...
const Resume = ({ name, resumes }) => {
  ...
  return (
    <div className="resume-panel h-full w-full flex flex-row flex-wrap">
      {/* <div className="user-wrapper"> */}
        <div className="user-panel flex-grow text-white bg-panel rounded-md m-2">
          <img
            className="border-accent rounded-t-md border-b-2 h-auto w-full"
            src={ProfileImage}
          />
